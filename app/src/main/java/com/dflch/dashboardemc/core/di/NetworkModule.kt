package com.dflch.dashboardemc.core.di
...
import com.dflch.dashboardemc.data.repository.network.NetworkRepositoryImpl
...
object NetworkModule {
    ...
    //conexiones para identificar el estado de la red (Wifi, datos moviles, etc)
    @Singleton
